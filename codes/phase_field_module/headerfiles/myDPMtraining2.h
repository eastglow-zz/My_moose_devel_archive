...
#ifndef MYDPMTRAINING2_H
#define MYDPMTRAINING2_H
...
class myDPMtraining2;
//class RankTwoTensor;

template <>
InputParameters validParams<myDPMtraining2>();

class myDPMtraining2 : public DerivativeMaterialInterface<JvarMapKernelInterface<Kernel>>
{
public:
  myDPMtraining2(const InputParameters & parameters);
...
protected:
  ...
  const VariableValue & _vz;
};

#endif // MYDPMTRAINING2_H
